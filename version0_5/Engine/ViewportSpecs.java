...
import version0_5.Components.Drawable;
...
public class ViewportSpecs {
    ...
    // Drawn object storage
    public DrawnObjects DO = new DrawnObjects();

    // action tracker
    public int action = 0;

    // action storage
    public ActionList actionList = new ActionList(DO);
    ...
    public Color WIRE_COLOR = Color.CYAN;
    public int WIRE_WIDTH = 1;
    public int wireAngle = 0;

    public Color RESISTOR_COLOR = Color.CYAN;
    public int RESISTOR_WIDTH = 1;
    public int RESISTOR_SPIKES_WIDTH_PER_GRID = 2;
    public int RESISTOR_SPIKES_HEIGHT = 40;

    public Color TRANSISTOR_COLOR = Color.CYAN;
    public int TRANSISTOR_WIDTH = 1;
    public int transistorRotation = 0;
